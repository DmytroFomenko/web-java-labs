...
<%--    <p>Model<input name="model" required></p>--%>
<%--    <p>Performance<input name="performance" required></p>--%>
<%--    <p>Price<input name="price" required></p>--%>
<%--    <br>--%>
<%--    <input type="submit" value="Save" class="tinybutton">--%>
<%--    <p></p>--%>
<%--    <p><a class="btn" href="smartphones"><span>back to Smartphones list</span></a></p>--%>
<%--</form>--%>
<a class="btn" href="smartphones"><span>Back to Smartphones list</span></a>

<form action="addSmartphone" method="post" class="inp">
