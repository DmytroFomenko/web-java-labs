...
<form action="logOutFDV" method="post" class="inline">
    <input type="submit" value="Log out" class="tinybutton2">
</form>
...
<%--<div style="margin: 15px">--%>
<%--    <form action="MailPostServlet" method="get" class="inline">--%>
<%--        <input type="submit" value="Send message" class="tinybutton2">--%>
<%--    </form>--%>
<%--</div>--%>
